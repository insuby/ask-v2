...
const StarOutline = (props: SVGProps<SVGSVGElement>) => {
  return (
    ...
    >
      <path
        opacity="0.3"
        d="M10 13.3996L6.24004 15.6696L7.24004 11.3896L3.92004 8.50961L8.30004 8.12961L10 4.09961L11.71 8.13961L16.09 8.51961L12.77 11.3996L13.77 15.6796L10 13.3996Z"
        fill="#D9E2FF"
      />
      <path
